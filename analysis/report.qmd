...
col_car_data <- read_csv("../data/clean/car_clean.csv")
head(col_car_data)
```
...
![Distribution of Buying Price by Safety Level](../output/eda_summary_buying_safety.png){#fig-buy height="300px"}

![Distribution of Number of Persons by Safety Level](../output/eda_summary_persons_safety.png){#fig-num height="300px"}

![Distribution of Maintenance Cost by Safety Level](../output/eda_summary_maint_safety.png){#fig-main height="300px"}
